...
<head>
  ...
  <title>Daftar User - Aplikasi Pembayaran</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?=base_url()?>">Daftar User - <b>SMK</b> TI</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?=base_url()?>login/proses_daftar_user" method="post">
        <div class="input-group mb-3">
          <input autofocus required name="nama" id="nama" type="text" class="form-control" placeholder="Nama Lengkap">
        ...
        <div class="input-group mb-3">
          <input required name="no_telfon" id="no_telfon" type="number" class="form-control" placeholder="Isi NOmor telfon aktif">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-envelope"></span>
            </div>
          ...
          <div class="form-group">
            <div class="custom-control custom-radio">
              <input class="custom-control-input" type="radio" id="jk" name="jk" value="L" checked>
              <label for="jk" class="custom-control-label">Laki-laki</label>
            </div>
            <div class="custom-control custom-radio">
              <input class="custom-control-input" type="radio" id="pr" name="jk" value="P">
              <label for="pr" class="custom-control-label">Perempuan</label>
            </div>
          </div>
        <div class="input-group mb-3">
